...
CREATE TABLE [dbo].[Tour](
	...
	[tgTapTrung] [time] NULL,
	[tgKhoiHanh] [time] NULL,
	[ngayDi] [date] NULL,
	[soNgay] [int] NULL,
	[soVeConLai] [int] NULL,
	[gia] [money] NULL,
...
INSERT INTO Tour 
values ('DL230323','16:00:00','2023-05-0317:05:00', N'Đà Lạt', 3, 10, 5000000,(SELECT * FROM OPENROWSET(BULK N'T:\img\hinh1.jpg', SINGLE_BLOB) as img),N'TP.Hồ Chí Minh',N'Vũng Tàu',getdate())
go

select * from Tour order by tgCapNhat desc

INSERT INTO Tour 
values ('DN230503','11:30:00','2023-05-03 12:30:00',  4, 14, 7000000,(SELECT * FROM OPENROWSET(BULK N'T:\img\hinh2.jpg', SINGLE_BLOB) as img) ,N'Đà Nẵng',N'TP.Hồ Chí Minh',N'Vũng Tàu',getdate())
INSERT INTO Tour 
values ('TN230423', N'Tây Ninh','2023-04-23 6:30:00', 2, 9, 3000000,(SELECT * FROM OPENROWSET(BULK N'T:\img\hinh3.jpg', SINGLE_BLOB) as img),N'TP.Hồ Chí Minh',N'Vũng Tàu',getdate())
INSERT INTO Tour 
